...
def load_and_transform_vision_data(image_paths, device):
    ...
    for image_path in image_paths:
        data_transform = transforms.Compose(
            [
                transforms.Resize(
                    240, interpolation=transforms.InterpolationMode.BICUBIC
                ),
        ...
        #with open('/data2/shengwang/AnomalyGPT/data/mvtec_anomaly_detection/bottle/test/broken_large/000.png', "rb") as fopen:
...
class SpatialCrop(nn.Module):
    ...
    def __init__(self, crop_size: int = 240, num_crops: int = 3):
        super().__init__()
...
def load_and_transform_video_data(
    ...
    video_transform = transforms.Compose(
        [
            pv_transforms.ShortSideScale(240),
            NormalizeVideo(
                mean=(0.48145466, 0.4578275, 0.40821073),
                std=(0.26862954, 0.26130258, 0.27577711),
            ),
    ...
    for video_path in video_paths:
        ...
        all_video = SpatialCrop(240, num_crops=3)(all_video)
