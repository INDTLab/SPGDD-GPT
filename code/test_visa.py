...
model.load_state_dict(delta_ckpt, strict=False)
#myModelPTPath = '/data2/shengwang/PromptAD/result/mvtec/k_1/checkpoint/SEG-Seed_111-bottle-check_point.pt'
#myModel = torch.load(myModelPTPath, map_location=torch.device('cpu'))
#new_state_dict = {}
#for k, v in myModel.items():
#    if (k=='feature_gallery1'):
#        new_state_dict['myModel.feature_gallery1'] = v
#    if (k=='feature_gallery2'):
#        new_state_dict['myModel.feature_gallery2']=v
#    if (k=='text_features'):
#        new_state_dict['myModel.text_features']=v
